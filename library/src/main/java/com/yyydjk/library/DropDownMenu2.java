 ...
 */
public class DropDownMenu2 extends LinearLayout {
    ...
    public DropDownMenu2(Context context) {
        super(context, null);
    }

    public DropDownMenu2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DropDownMenu2(Context context, AttributeSet attrs, int defStyleAttr) {
